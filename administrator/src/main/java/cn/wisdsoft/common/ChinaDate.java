...
public class ChinaDate {
    ...
    public static String lunarToSolar(String lunarDate, boolean leapMonthFlag) throws Exception {
        ...
        String substring = lunarDate.substring(8, 10);
        int lunarDay = Integer.parseInt(substring);
...
//            return "阴历："+lunarYear+"年"+(leapMonthFlag&(lunarMonth==leapMonth)?"闰":"")+lunarMonth+"月"+lunarDay+"日";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(ChinaDate.lunarToSolar("1997-12-25", false));
        System.out.println("阳历转阴历************");
        System.out.println(ChinaDate.solarToLunar("1997-03-05", true));
    }

    /**
     * 返回定时器时间规则
     */
    public static String cron(String cronRole) {
        String cron = "";
        String year = cronRole.substring(0, 4);
        String month = cronRole.substring(5, 7);
        String day = cronRole.substring(8, 10);
        //七个字段（秒 分 时 天 周 月 年<非必填>）
        cron = "0 0 0 " + day + " " + month + " *";
        return cron;
    }

    public static String TermRulecron(String cronRole) {
//        String cron ="0 0 0 " + cronRole.substring(8, 10) + " " + cronRole.substring(5, 7) + " ? "+cronRole.substring(0, 4);
//        String cronRole = "2019-05-12 14:42:30";
        String cron =cronRole.substring(17, 19)+" "+cronRole.substring(14, 16)+" "+cronRole.substring(11, 13)+" "+cronRole.substring(8, 10) + " " + cronRole.substring(5, 7) + " ? "+cronRole.substring(0, 4);
        return cron;
    }
